...
# model = Transformer(input_dim=5, hidden_dim=64, output_dim=3, n_layers=5, n_heads=4, dropout=0.1).to(device)
...
for epoch in tqdm(range(num_epochs)):
    for trajs, labels, idx in train_dataloader:
